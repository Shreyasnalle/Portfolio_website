...
export function ProfileHeader() {
  return (
    <div className="relative flex h-[112px] w-full items-center px-4 z-20">
      <div className="flex items-center gap-4 sm:gap-5">
        ...
        <div className="flex flex-col justify-center">
          <PixelHeading
            mode="uniform"
            as="h1"
            className="text-[20px] sm:text-[24px] font-bold text-zinc-800 dark:text-zinc-100 tracking-tight leading-none cursor-pointer"
          >
            Shreyas Nalle
          </PixelHeading>
        </div>
