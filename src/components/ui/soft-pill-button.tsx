        ...
        <span
          ...
          className={cn(
            ...
            isPrimary
              ...
              : "bg-white/90 dark:bg-[#0c0c0e] group-hover:dark:bg-[#121214] border border-black/5 dark:border-white/5 group-hover:border-black/10 dark:group-hover:border-white/10 shadow-sm"
          )}
        >
          {!isPrimary && (
            <span
